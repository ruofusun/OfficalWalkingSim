...
public class CrowRotateHeadToTarget :  Action
{
  ...
  private CrowController crow;
    ...
    public override void OnStart()
    {
       ...
       if (target == null)
       {
           target.Value = crow.target.transform.position;
       }
    }
    ...
    public override TaskStatus OnUpdate()
    {
        ...
        var _direction = ( crow.target.transform.position- transform.position).normalized;
